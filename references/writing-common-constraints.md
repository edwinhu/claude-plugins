...
|------------|------|-------------|
| Progressive Expansion Hierarchy | [constraints/progressive-expansion-hierarchy.md](constraints/progressive-expansion-hierarchy.md) | 4-level hierarchy and 3 Iron Laws (NO OUTLINE WITHOUT PRECIS, etc.) |
...
| Flowchart Authority | [constraints/flowchart-authority.md](constraints/flowchart-authority.md) | Flowchart IS the spec — text is commentary |
| No Pause Between Phases | [constraints/no-pause-between-phases.md](constraints/no-pause-between-phases.md) | Immediately load next skill after gate passes |
...
| Claim ID Traceability | [conventions/claim-id-traceability.md](conventions/claim-id-traceability.md) | How CLAIM-XX IDs flow from PRECIS through all artifacts |
