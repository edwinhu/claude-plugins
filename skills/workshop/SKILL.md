...
```js
{
  ...
  tasks: [
    { id: "section-1",
      ...
      refs: ["${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/workshop-checks.md",
             ...
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-slide-format.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-formatting.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-bullet-spacing.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-teleprompter-notes.md",
    ...
    { id: "assemble",
      ...
      refs: ["${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/workshop-checks.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/slide-spec-grammar.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-section-hierarchy.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-common-elements.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-notes-structure.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/templates/theme.typ",
  ...
  mechanicalChecks: [
    ...
    { name: "constraints",
      cmd: "python3 ${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/run-constraints.py presentation" },
    { name: "probe-tests",
  ...
  reviewLenses: [
    ...
    { key: "deck-convention",
      ...
      refs: ["${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/workshop-checks.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-bullet-spacing.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-cetz-diagrams.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-common-elements.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-computed-values.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-fletcher-diagrams.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-formatting.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-images.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-label-bullet-spacing.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-no-subtitle-echo.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-notes-structure.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-section-hierarchy.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-slide-format.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-sub-bullets.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-tables.md",
             "${CLAUDE_PLUGIN_ROOT}/skills/workshop/references/constraints/typst-teleprompter-notes.md"],
