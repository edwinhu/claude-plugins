...
```js
{
  ...
  authorityExtra: [
    ...
    "Standing DS doer authority — every implementation task loads all four aggregates and follows their indexed constraints: ${CLAUDE_PLUGIN_ROOT}/skills/ds/references/ds-common-constraints.md; ${CLAUDE_PLUGIN_ROOT}/skills/ds/references/ds-common-conventions.md (V1-V9: assumption-over-evidence, deferred verification, statistical validity, P-hacking prevention, sample-selection documentation); ${CLAUDE_PLUGIN_ROOT}/skills/ds/references/ds-analysis-constraints.md (A1-A5: robustness checks, standard-error specification, visualization integrity, table-figure pairing, chart typography); ${CLAUDE_PLUGIN_ROOT}/skills/ds/references/ds-engineering-constraints.md (E1-E5: determinism and seeds, schema contracts, join audits with row counts and match rates, idempotency, loud error handling).",
