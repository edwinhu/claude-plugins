...
Reference for all 11 superpowers behavioral enforcement patterns. Use when creating, auditing, or improving workflows.
...
**When to use:** Verification and review phases where the agent might rubber-stamp.

**What it does:** Reframes approval-without-evidence as dishonesty, which LLMs are strongly trained to avoid.
...
**Key insight:** "Lying" and "fraud" are stronger frames than "incorrect" or "premature". The model's honesty training makes these frames highly effective.
...
Recommended patterns: Iron Laws, Rationalization Tables, Gate Functions, Honesty Framing, Delete & Restart, No Pause Between Tasks
