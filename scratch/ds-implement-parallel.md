...
Use this section when the user chose "Agent team (parallel)" in strategy choice.

> **Prerequisite:** Requires `CLAUDE_CODE_EXPERIMENTAL_AGENT_TEAMS` enabled. If unavailable, fall back to sequential delegation via ds-delegate.
