...
Discover and read the implement phase skill:
```bash
ls -d ~/.claude/plugins/cache/edwinhu-plugins/workflows/*/lib/skills/dev-implement/SKILL.md 2>/dev/null | sort -V | tail -1
```
