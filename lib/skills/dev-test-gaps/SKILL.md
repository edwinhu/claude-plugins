...
For each requirement in SPEC.md:
  - Extract the requirement ID or description
  - Note the acceptance criteria
  - Note any specific behavior described
```
...
3. **Record the mapping:** requirement -> test file -> specific test(s)
...
|-------------|-----------|--------|-------|
| [from SPEC] | [test path] | COVERED/PARTIAL/MISSING | [details] |

## Gaps Filled
| Requirement | Test File | Result |
|-------------|-----------|--------|
| [requirement] | [new test path] | PASS/FAIL (escalated) |
