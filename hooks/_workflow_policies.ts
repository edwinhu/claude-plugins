...
const POLICIES: Readonly<Record<WorkflowName, WorkflowPolicy>> = Object.freeze({
  ...
  writing: Object.freeze({ workflow: "writing", clarifySentinel: ".planning/WRITING_CLARIFIED.json", clarifyReason: "Ask the opening thesis, audience, scope, source, deliverable, and evidence questions before reading project writing or searching sources.", reviewerVerdict: ".planning/PLAN_REVIEWED.md", allowedOrchestratorDirectories: Object.freeze([".planning", ".claude"]) }),
  workshop: Object.freeze({ workflow: "workshop", clarifySentinel: ".planning/WORKSHOP_CLARIFIED.json", clarifyReason: "Ask the opening paper, audience, duration, structure, visual, output, and evidence questions before reading the paper or presentation project.", reviewerVerdict: ".planning/PLAN_REVIEWED.md", allowedOrchestratorDirectories: Object.freeze([".planning", ".claude"]) }),
  "workflow-creator": Object.freeze({ workflow: "workflow-creator", clarifySentinel: ".planning/WC_CLARIFIED.json", clarifyReason: "Ask the desired workflow outcome, target repository, scope, exclusions, failure modes, and evidence before inspecting workflow files.", reviewerVerdict: ".planning/PLAN_REVIEWED.md", allowedOrchestratorDirectories: Object.freeze([".planning", ".claude"]) }),
});
function builtInWorkflowFromArg(argv: string[]): WorkflowPolicy | null {
  ...
  return name === "ds" || name === "dev" || name === "writing" || name === "workshop" || name === "workflow-creator" ? POLICIES[name] : null;
}
