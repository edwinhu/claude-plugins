...
if (cfg.capturedApprovalBundle === undefined) {
  artifact = approvalMode === 'generated-plan-receipt-v1'
    ? validateGeneratedPlanArtifact(PROJECT, cfg.workflow, process.env.CLAUDE_SESSION_ID)
    : validateApprovedArtifact(PROJECT, cfg.workflow, process.env.CLAUDE_SESSION_ID, cfg.approvalPolicy)
