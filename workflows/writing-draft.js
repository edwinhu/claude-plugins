...
- RHYTHM (positive target, not just prohibitions): vary sentence and paragraph length deliberately — mix short, punchy sentences with longer developed ones; let a pivotal claim land in a short sentence. Use semicolons where two clauses genuinely balance; use em-dashes sparingly and only for a real appositive/aside (not as a default connector). Burstiness — high variance in sentence length — is what human legal prose has and machine prose lacks.
